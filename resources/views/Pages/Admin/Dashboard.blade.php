...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold mb-6 text-center">Welcome, <span class="text-green-500">{{ $getUser->username }}</span>!
        </h1>
        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <div class="bg-white rounded-lg shadow p-6 flex-1" tabindex="0" aria-label="Quick Actions">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="#"
                        class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300">Add
                        User</a>
                    <a href="#"
                        class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-300">Add
                        Order</a>
                    <a href="#"
                        class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-300">Add
                        Product</a>
                </div>
            </div>
        </div>
